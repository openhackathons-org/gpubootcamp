...
def main():
    ...
    pgie.set_property('config-file-path', "../source_code/N2/dstest4_pgie_config.txt")
    sgie1.set_property('config-file-path', "../source_code/N2/dstest4_sgie1_config.txt")
    sgie2.set_property('config-file-path', "../source_code/N2/dstest4_sgie2_config.txt")
    sgie3.set_property('config-file-path', "../source_code/N2/dstest4_sgie3_config.txt")
    ...
    src_pad=queue6.get_static_pad("src")
    if not src_pad:
